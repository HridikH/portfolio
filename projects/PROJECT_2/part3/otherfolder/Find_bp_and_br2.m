...
% Run this function with the data you log when running Part3.slx
% [bpMax, brMax] = Find_bp_and_br(ReacData(:,1),ReacData(:,2),ReacData(:,3),ReacData(:,4))  
...
function [bpMax, brMax] = Find_bp_and_br2(plot_time, Theta_p,Theta_r,uinput)
%% plot the data
