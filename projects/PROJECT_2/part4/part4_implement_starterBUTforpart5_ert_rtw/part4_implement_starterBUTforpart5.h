 ...
 *
 * File: part4_implement_starterBUTforpart5.h
 *
...
#ifndef part4_implement_starterBUTforpart5_h_
#define part4_implement_starterBUTforpart5_h_
#ifndef part4_implement_starterBUTforpart5_COMMON_INCLUDES_
#define part4_implement_starterBUTforpart5_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#include "IQmathLib.h"
#endif                 /* part4_implement_starterBUTforpart5_COMMON_INCLUDES_ */
...
#define part4_implement_starterBUTforpart5_M (part4_implement_starterBUTfo_M)
...
typedef struct {
  ...
  boolean_T OR;                        /* '<S2>/OR' */
} B_part4_implement_starterBUTf_T;
...
} DW_part4_implement_starterBUT_T;

/* Continuous states (default storage) */
typedef struct {
  real_T StateSpace_CSTATE[4];         /* '<Root>/State-Space' */
  real_T TransferFcn_CSTATE;           /* '<Root>/Transfer Fcn' */
} X_part4_implement_starterBUTf_T;

/* State derivatives (default storage) */
typedef struct {
  real_T StateSpace_CSTATE[4];         /* '<Root>/State-Space' */
  real_T TransferFcn_CSTATE;           /* '<Root>/Transfer Fcn' */
} XDot_part4_implement_starterB_T;

/* State disabled  */
typedef struct {
  boolean_T StateSpace_CSTATE[4];      /* '<Root>/State-Space' */
  boolean_T TransferFcn_CSTATE;        /* '<Root>/Transfer Fcn' */
} XDis_part4_implement_starterB_T;
...
struct P_part4_implement_starterBUTf_T_ {
  ...
  real_T Constant3_Value;              /* Expression: 1
                                        ...
                                        */
  real_T StateSpace_B[12];             /* Expression: [B L_new]
                                        * Referenced by: '<Root>/State-Space'
                                        */
  ...
  real_T phi_r_Gain_Gain;              /* Expression: (2*pi)/4000
                                        ...
                                        */
  real_T Gain_Gain[4];            /* Expression: -[-190.1316,-18.3993,0,-0.0305]
...
struct tag_RTM_part4_implement_start_T {
  ...
  X_part4_implement_starterBUTf_T *contStates;
  int_T *periodicContStateIndices;
  real_T *periodicContStateRanges;
  real_T *derivs;
  XDis_part4_implement_starterB_T *contStateDisabled;
...
extern P_part4_implement_starterBUTf_T part4_implement_starterBUTfor_P;

/* Block signals (default storage) */
extern B_part4_implement_starterBUTf_T part4_implement_starterBUTfor_B;

/* Continuous states (default storage) */
extern X_part4_implement_starterBUTf_T part4_implement_starterBUTfor_X;

/* Disabled states (default storage) */
extern XDis_part4_implement_starterB_T part4_implement_starterBUT_XDis;

/* Block states (default storage) */
extern DW_part4_implement_starterBUT_T part4_implement_starterBUTfo_DW;

/* Zero-crossing (trigger) state */
extern PrevZCX_part4_implement_start_T part4_implement_starter_PrevZCX;

/* Constant parameters (default storage) */
extern const ConstP_part4_implement_starte_T part4_implement_starterB_ConstP;

/* Model entry point functions */
extern void part4_implement_starterBUTforpart5_initialize(void);
extern void part4_implement_starterBUTforpart5_step(void);
extern void part4_implement_starterBUTforpart5_terminate(void);

/* Real-time Model object */
extern RT_MODEL_part4_implement_star_T *const part4_implement_starterBUTfo_M;
 ...
 *
 * '<Root>' : 'part4_implement_starterBUTforpart5'
 * '<S1>'   : 'part4_implement_starterBUTforpart5/Asymmetric  Linear Friction'
 * '<S2>'   : 'part4_implement_starterBUTforpart5/Reaction Wheel '
 * '<S3>'   : 'part4_implement_starterBUTforpart5/Reaction Wheel /Triggered Subsystem'
 */
#endif                               /* part4_implement_starterBUTforpart5_h_ */
