...
void rt_OneStep(void)
{
  ...
  part4_implement_starterBUTforpart5_step();
...
int main(void)
{
  ...
  ;
  rtmSetErrorStatus(part4_implement_starterBUTfo_M, 0);
  ...
  part4_implement_starterBUTforpart5_initialize();
  globalInterruptDisable();
  globalInterruptEnable();

  /* External Mode initialization */
  errorCode = extmodeInit(part4_implement_starterBUTfo_M->extModeInfo,
    (extmodeSimulationTime_T *)rteiGetPtrTFinalTicks
    (part4_implement_starterBUTfo_M->extModeInfo));
  if (errorCode != EXTMODE_SUCCESS) {
  ...
  if (errorCode == EXTMODE_SUCCESS) {
    ...
    if (extmodeStopRequested()) {
      rtmSetStopRequested(part4_implement_starterBUTfo_M, true);
    }
  }
  ...
  runModel =
    ...
    !rtmGetStopRequested(part4_implement_starterBUTfo_M);
  enableTimer0Interrupt();
  config_ePWM_TBSync();
  globalInterruptEnable();
  while (runModel) {
  ...
  /* Terminate model */
  part4_implement_starterBUTforpart5_terminate();
