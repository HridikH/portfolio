...
# UR3 home location
home = [0 * PI / 180.0, 0 * PI / 180.0, 0 * PI / 180.0,
...
def move_block(pub_cmd, loop_rate, start_xw_yw_zw, target_xw_yw_zw, vel, accel):
    ...
    x, y, z = start_xw_yw_zw[0][0], start_xw_yw_zw[1][0], 32
    start_dest = lab_invk(x, y, z, 90)
...
class ImageConverter:
    ...
    def image_callback(self, data):
        ...
        g = blob_search(cv_image, "green")
        o = blob_search(cv_image, "orange")
...
def main():
    ...
    if len(xw_yw_O) != 0:
        move_block(pub_command, loop_rate, xw_yw_O[0], 0, vel, accel)
